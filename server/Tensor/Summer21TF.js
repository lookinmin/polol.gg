...
const getTeamData = async () => {
  try {
    return await axios.get('https://gol.gg/teams/list/season-ALL/split-ALL/tournament-LCK%20Summer%202021/');
  } catch (error) {
    throw error;
  }
}
...
const getPlayerData = async () => {
  try {
    return await axios.get('https://gol.gg/players/list/season-ALL/split-ALL/tournament-LCK%20Summer%202021/');
  } catch (error) {
    throw error;
  }
}
