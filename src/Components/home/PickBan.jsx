    ...
    <>
      <div className="championsChamp">
        ...
        <div className="championsChampInfo">
          <div className="championsChampName">{name[2]}</div>
      ...
      <div className="championsChamp">
        ...
        <div className="championsChampInfo">
          <div className="championsChampName">{name[1]}</div>
      ...
      <div className="championsChamp">
        <div className="championsChampPic">
          <img src={url[0]} height="auto" width="100px"></img>
        </div>
        <div className="championsChampInfo">
          <div className="championsChampName">{name[0]}</div>
